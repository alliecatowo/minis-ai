...
async def test_handle_issue_comment_review_request_posts_pr_review_and_records_prediction():
            ...
            "comments": [
                {
                    ...
                    "rationale": "This path now decides whether failures are surfaced or swallowed.",
                    "path": "app/retry.py",
                    "line": 42,
                    "side": "RIGHT",
    ...
    assert post_review.await_args.kwargs["comments"][0]["path"] == "app/retry.py"
    assert "```suggestion" in post_review.await_args.kwargs["comments"][0]["body"]
    assert "fw-retry-tests" in post_review.await_args.kwargs["comments"][0]["body"]
    ...
    assert post_review.await_args.kwargs["comments"] == [
        {
            ...
            "body": (
                ...
                "Why: This path now decides whether failures are surfaced or swallowed. "
