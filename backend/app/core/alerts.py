...
def alert_budget_threshold(user_id: str, spent: float, budget: float, pct: float) -> None:
...
def alert_expensive_request(user_id: str | None, model: str, cost: float, tokens: int) -> None:
