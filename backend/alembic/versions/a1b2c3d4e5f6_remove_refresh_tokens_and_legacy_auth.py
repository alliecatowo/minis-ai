...
def upgrade() -> None:
    ...
    op.alter_column("users", "github_username", existing_type=sa.String(255), nullable=True)


def downgrade() -> None:
    # Restore github_username as non-nullable
    op.alter_column("users", "github_username", existing_type=sa.String(255), nullable=False)
